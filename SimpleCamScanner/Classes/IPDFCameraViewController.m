...
-(void)captureOutput:(AVCaptureOutput *)captureOutput didOutputSampleBuffer:(CMSampleBufferRef)sampleBuffer fromConnection:(AVCaptureConnection *)connection
{
    ...
    soureImg = [CIImage imageWithCVPixelBuffer:pixelBuffer];
    
    if (self.cameraViewType != IPDFCameraViewTypeNormal)
    {
        soureImg = [self filteredImageUsingEnhanceFilterOnImage:soureImg];
    }
    else
    {
        soureImg = [self filteredImageUsingContrastFilterOnImage:soureImg];
    }
...
//        {
//            _borderDetectLastRectangleFeature = [self biggestRectangleInRectangles:[[self highAccuracyRectangleDetector] featuresInImage:soureImg]];
...
//            
//            soureImg = [self drawHighlightOverlayForPoints:soureImg topLeft:_borderDetectLastRectangleFeature.topLeft topRight:_borderDetectLastRectangleFeature.topRight bottomLeft:_borderDetectLastRectangleFeature.bottomLeft bottomRight:_borderDetectLastRectangleFeature.bottomRight];
//        }
//        else
//        {
...
//    }
    ...
    if (self.context && _coreImageContext)
    {
        ...
        [_coreImageContext drawImage:soureImg inRect:self.bounds fromRect:[soureImg extent]];
        [_glkView display];
        
        if(_intrinsicContentSize.width != soureImg.extent.size.width) {
            self.intrinsicContentSize = soureImg.extent.size;
